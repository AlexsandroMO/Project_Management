...
from .models import MyProject, DocumentBase #, PageT, DocT, DocumentStandard, Subject, Action, StatusDoc, Employee, Cotation, Upload, ProjectValue, LdProj
...
def DocumentList(request):
  ...
  return render(request, 'proj/document-list.html') #, {'MyProjects': MyProjects,'proj':proj, 'Employees':Employees, 'colaborador':colaborador, 'photo_colab':photo_colab})
...
def BaseDoc(request):
  ...
  return render(request, 'proj/document-base.html',{'DocumentBases':DocumentBases, 'MyProjects':MyProjects}) #, {'MyProjects': MyProjects,'proj':proj, 'Employees':Employees, 'colaborador':colaborador, 'photo_colab':photo_colab})
